...
userLogin = {"name": "Hafidz ganteng banget", "age":18, "role":"Assault/Medic"}
...
userLogin["email"] = "hafidzkahfianka14@gmail.com"
print(userLogin)
...
#nested dictionary
dbUser = {"user1": {"name": "Hafidzkerenbgt", "age": 18, "role": "raja uinssc"},
